...
import { SIGN_IN_LINK_MAX_AGE } from "@/lib/email/sign-in-email";
...
/** Shown after a sign-in link is requested. Says the same thing whether or not the address has an account. */
    ...
    <Container className="pt-12 pb-24 md:pt-20 md:pb-32">
      <div className="mx-auto max-w-md">
        ...
        <p className="mt-5 text-body text-muted-foreground">
          We&rsquo;ve sent you a sign-in link. Open it on this device to sign in — it works once and expires in{" "}
          {minutes} minutes.
        </p>
        <div className="mt-12 border-t pt-8">
          ...
          <TextLink href="/account/sign-in" className="mt-4">
            Back to sign in
          </TextLink>
        </div>
      </div>
